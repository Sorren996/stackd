    ...
    <>
      ...
      {!doseFormOpen && (
        <button
          ...
          className="fixed bottom-24 right-5 z-40 flex h-14 w-14 items-center justify-center overflow-hidden rounded-full border transition active:scale-95 backdrop-blur-2xl"
          style={{
