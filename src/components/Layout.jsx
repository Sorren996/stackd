...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 z-50 p-[1px] bg-gradient-to-b from-white/30 to-transparent rounded-2xl overflow-hidden max-w-sm mx-auto" style={{ background: 'rgba(8, 14, 10, 0)', backdropFilter: 'blur(2px)', WebkitBackdropFilter: 'blur(2px)' }}>
