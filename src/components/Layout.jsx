  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="fixed bottom-0 inset-x-0 z-50 flex justify-center pb-safe">
        <div
          className="mx-4 mb-4 flex items-center gap-1 px-3 py-1 rounded-3xl border border-white/15"
          style={{
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.path}
                to={item.path}
                className={`flex flex-col items-center gap-1 rounded-2xl transition-all py-0 px- ${
                isActive ?
