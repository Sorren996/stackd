  ...
  return (
    <div ref={containerRef} className="relative overflow-visible">
      ...
      {!isCandlestick && filters.glucose && glucoseLinePoints.length > 0 &&
          ...
          <div className="flex items-center justify-center gap-1.5 text-2xl font-black leading-none" style={{ color: "#c6a06aff" }}>
          ...
          <div ref={tooltipTimeRef} className="mt-1 text-xs font-medium" style={{ color: "#c6a06aff" }}>{format(new Date(glucoseLinePoints[glucoseLinePoints.length - 1].time), "h:mm a")}</div>
          <div ref={tooltipDateRef} className="mt-0.5 text-[10px] font-medium" style={{ color: "#c6a06aff" }}>{format(new Date(glucoseLinePoints[glucoseLinePoints.length - 1].time), "EEEE, MMM d")}</div>
        </div>
          }
      {!isCandlestick && filters.glucose && glucoseLinePoints.length > 0 &&
          <div
