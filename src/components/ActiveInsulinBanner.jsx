    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="theme-popover relative w-full max-w-xs overflow-hidden rounded-2xl border p-4 shadow-2xl backdrop-blur-2xl"
          style={{
      ...
      <div className="relative -mx-4 px-4 pb-6 pt-2">
        <div className="mb-6 flex flex-col items-center pt-2 text-center">
          ...
          <div
            ...
            style={{
              background: `linear-gradient(145deg, rgba(255,255,255,0.16), ${glucoseColor}12)`,
