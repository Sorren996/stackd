...
<div className="relative flex flex-col items-center text-center mb-6 pt-8 pb-8 overflow-visible rounded-[28px]">
  {/* Main glucose orb */}

  <motion.div
    aria-hidden    className="absolute left-0 top-1/2 w-72 h-72 -translate-x-1/2 -translate-y-1/2 rounded-full pointer-events-none"
    animate={{
      scale: [0.75, 1, 0.75],
