...
export default function DayComparison({ comparison }) {
  ...
  return (
    <DaySection icon={BarChart3} iconColor="#5b6550" label="Compared with Your Usual" collapsible>
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <div
            className="rounded-xl px-3 py-2.5"
            style={{ background: "rgba(91,101,80,0.06)", border: "1px solid rgba(91,101,80,0.15)" }}
          >
